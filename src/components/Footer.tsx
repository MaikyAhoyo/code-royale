    ...
    <footer className="bg-secondary/50 border-t border-border py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl text-gradient">CodeMaster</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Java</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">C++</a></li>
        ...
        <div className="pt-8 border-t border-border text-center text-sm text-muted-foreground">
          <p>© 2024 CodeMaster. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
